...
fn check_game_status() {
    for row in 0..10 {
        for col in 0..10 {
            ...
            assert_eq!(rc.get_game_status(), GsGameOver(CtWhite));
            ...
            assert_eq!(rc.get_game_status(), GsGameOver(CtBlack));
            ...
            assert_eq!(rc.get_game_status(), GsGameOver(CtBlack));        // O _ X O X
